...
export const ConsolePageConsole = (props: ConsolePageConsolePropsType) => {
    const {isFetching, request, response, requestSuccess, sendRequest} = props;
                          ...
                          <div className={'consoleBody'}>
                              ...
                              <div className={'consoleBody_rightPart'}>
                                  <Field name="response"
                                        ...
                                        {({input, meta}) => {
                                          return <ConsoleResponseField response={response} requestSuccess={requestSuccess} input={input} meta={meta}/>
                                      }}
                                  </Field>
                              </div>
                          </div>
